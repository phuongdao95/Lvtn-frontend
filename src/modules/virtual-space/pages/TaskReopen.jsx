...
import { useUpdateTask, useFetchOneTask, useFetchTaskLabelsOfTask, useCreateTask } from '../../../client/taskService';
...
export default function TaskReopen({ reload, taskId, closeDialogCb }) {
                ...
                <TwoColumnBox
                    firstSlot={
                        <Fragment>
                            ...
                            <Typography sx={{padding: 0.75}}>Todo</Typography>
                        </Fragment>
                    }
