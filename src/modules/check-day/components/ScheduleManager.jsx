...
import SchedulerCardManager from "./ScheduleCardManage";
...
export default function ScheduleManager({ year, month, id }) {
    ...
    React.useEffect(() => {
        fetchWorkingShifts(id, `${(month % 12) + 1}/${year}`, 'month');
    }, [month, year])
